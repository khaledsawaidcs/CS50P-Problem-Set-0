from indoor import UpperToLower
from playback import SpaceToDots
...
#input_sentence_with_dots = input("Type in your sentence: ") #Playback Spped Test
#print (SpaceToDots(input_sentence_with_dots))
